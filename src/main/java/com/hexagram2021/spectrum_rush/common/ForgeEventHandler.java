...
@Mod.EventBusSubscriber(modid = SpectrumRush.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.DEDICATED_SERVER)
public class ForgeEventHandler {
	...
	public static void onLevelTick(TickEvent.LevelTickEvent event) {
		if(event.phase == TickEvent.Phase.END && SRCommonConfig.STARTED.get() && event.level instanceof ServerLevel serverLevel) {
